                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger deleteRole" href="<?php echo base_url(); ?>roles/delete/<?php echo $record->roleId ?>" data-roleid="<?php echo $record->roleId; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
