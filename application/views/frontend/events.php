...
<!-- member registration form -->
 ...
 -->                </div>
  ...
  <div class="main-content">
    ...
    <section id="upcoming-events" class="divider parallax layer-overlay overlay-white-8" data-bg-img="<!-- ./webassets/images/bg/bg1.jpg -->">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img1.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">Vikas samiti chhindoali head office</a></h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img2.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति ऑफिस का उद्घाटन महासमुन्द विधायक माननीय विमल चोपड़ा द्वारा किया गया।</a></h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img4.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">ST,SC कार्यक्रम दिल्ली में आयोजन में सम्मिलित।</a></h5>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img3.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">भारतीय रिजर्व बैंक गवर्नर डॉ. रघुराम राजन जी विकास समिति छिंदौली के  लोन वितरण कार्यक्रम आयोजन में शामिल।</a></h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img5.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति के तत्वाधान में भारतीय रिजर्व बैंक रायपुर लोन जानकारी में कार्यक्रम आयोजित किया गया।</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img6.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली का नाबार्ड द्वारा आयोजन कार्यक्रम</a></h5>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img7.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">नाबार्ड द्वारा आयोजित कार्यक्रम विकास समिति के तत्वाधान में,</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img8.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली का राष्ट्रीय कृषि और ग्रामीण विकास बैंक नाबार्ड द्वारा आयोजित कार्यक्रम,</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img9.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली के द्वारा जैविक खाद उत्पादन का जानकारी का कार्यक्रम का आयोजन हुआ।</a></h5>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img10.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली के तत्वाधान में बसना में दाल प्रसंस्करण  उद्घाटन कार्यक्रम आयोजित किया गया।</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img11.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली के तत्वाधान में नाबार्ड के द्वारा दाल प्रोसेसिंग कार्यशाला का आयोजन कराया गया।</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img12.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति छिंदौली के मीटिंग कार्यक्रम हेड ऑफिस में संपन्न हुवा।</a></h5>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img13.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति द्वारा दुग्ध व्यवसाय का संचालन किया गया।</a></h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="./webassets/images/events/img14.jpeg">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title"><a href="#">विकास समिति के द्वारा जैविक खाद उत्पादन की प्रक्रिया की जानकारी दिया गया।</a></h5>
                </div>
              </div>
            </div>
          </div>
