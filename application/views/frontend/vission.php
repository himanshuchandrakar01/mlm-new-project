    ...
    <section id="about2">
      <div class="container">
        <div class="section-content">
          <div class="row mt-10">
            <div class="col-sm-6 col-md-6 mb-sm-20">
              <h3 class="text-uppercase letter-space-1 mt-0">Vision</h3>
                <!-- <span class="text-theme-colored">  Network Worldwide.</span> -->
              <p class="lead mt-20 mb-30">हमारा उद्देश्य है सभी बहन बेटियों  के लिए  सामाजिक, व्यवहारिक  और आर्थिक परिवर्तन में मदत करना जिससे माँ बाप अपने  बच्चियों के  शिक्षा और  शादी को कभी बोझ न समझे साथ ही अच्छा जीवन जीने का समान अवसर हों।</p>
              <br>
              <h3 class="text-uppercase letter-space-1 mt-0">Mission</h3>
                <!-- <span class="text-theme-colored">  Network Worldwide.</span> -->
              <p class="lead mt-20 mb-30">हम यह सुनिश्चित करने के लिए मौजूदा समुदाय और सरकारी संसाधनों का लाभ उठाते हैं ताकि बहन बेटियों के शादी में मदत कर सके।एवम महिलाओं का आर्थिक स्तर को मजबूत करना।</p>
              <br>

              <h3 class="text-uppercase letter-space-1 mt-0">Goal</h3>
                <!-- <span class="text-theme-colored">  Network Worldwide.</span> -->
              <p class="lead mt-20 mb-30"> हमारा लक्ष्य 2025 तक संचयी रूप से 1 लाख  से अधिक बहन बेटियों  के शादी में सहयोग और लाभ पहुँचाना।</p>

              
            </div>
            <div class="col-sm-6 col-md-6 mb-sm-20">
              <img src="./webassets/images/bg/bg15.jpeg" alt="">
            </div>
          </div>
        </div>
      </div>
