    ...
    <div class="id-card">
      ...
      <div class="container idback"> 
        <div class="row">
          ...
          <h4 class="rolename">SHAGON YOJANA</h4>
        </div>
      </div>
      <!-- <div class="photo">
...
<style>
  .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
    ...
    line-height: 11px;
      ...
      <table class="table table-bordered table-responsive" style="margin-top: 45px;">
        <tr>
          <td><label style="font-size: 10px;">ID No.:</label></td>
          <td><label style="font-size: 10px;">9876543210</label></td>
        </tr>
        <tr>
          <td><label style="font-size: 10px;">Aadhar No.:</label></td>
          <td><label style="font-size: 10px;">987654321098</label></td>
        </tr>
        <tr>
          <td><label style="font-size: 10px;">Email :</label></td>
          <td><label style="font-size: 10px;">9876543210</label></td>
        </tr>
        <tr>
          <td><label style="font-size: 10px;">Valid from :</label></td>
          <td><label style="font-size: 10px;">15/05/2023</label></td>
        </tr>
        <tr>
          <td><label style="font-size: 10px;">Valid To  :</label></td>
          <td><label style="font-size: 10px;">15/08/2023</label></td>
        </tr>
      </table>
      <h2 class="bottom"></h2>
    </div>
    ...
    <div class="id-card">
      ...
      <div class=""> 
        <div class="row">
          <img src="assets/images/qrcard.png" style="width: 100px; height: 100px;">
...
<style>
  .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {
    ...
    line-height: 11px;
      ...
      <table class="table table-bordered table-responsive" style="margin-top: 11px;">
        <tr>
          <td style="width: 70px;"><label style="font-size: 10px;">S/D/W of :</label></td>
          <td><label style="font-size: 10px;">Vijay Sharma</label></td>
        </tr>
        <tr>
          <td><label style="font-size: 10px;">DOB :</label></td>
          <td><label style="font-size: 10px;">19/03/1987</label></td>
        </tr>
        <tr>
      ...
      <p class="bottom">Address :- Ward No. 4, Near Under Pass Sadulshahar, Dis. Sri Ganganagar, Rajasthan, Email - vikassamiti1415@gmail.com, Mobile No. - +91 8839244682</p>
    </div>
  </div>
      </div>
      <div class="col-md-2"></div>
