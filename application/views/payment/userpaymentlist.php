<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i>User Payment Management
                    ...
                    <tr>
                      ...
                      <!--   <td><?php echo $record->name ?></td> -->
                        ...
                        <td class="text-center">
                          ...
                          <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal<?php echo $record->name ?>"><i class="fa fa-pencil"></i></button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="text" name="" value="<?php echo $record->holder_name ?>" class="form-control">
            <label>Mail To</label>
            <input type="text" name="email" class="form-control" value="<?php echo $record->email; ?>">
            <label>Claim Amount</label>
            <input type="text" name="" value="<?php echo $record->amount ?>" class="form-control">
            <label>Received Amount</label>
            <input type="text" name="amount" value="<?php echo $record->amount ?>" class="form-control">
