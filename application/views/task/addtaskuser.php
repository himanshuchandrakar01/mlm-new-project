              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <!-- <form role="form" id="addTask" action="<?php echo base_url() ?>task/addNewTask" method="post" role="form"> -->
                         <form action="addtaskuser_db" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                  ...
                                  <input type="text" name="assistant_id" class="form-control" value="<?=$_SESSION['mobile']?>"readonly>
                                   <input type="hidden" name="id" class="form-control" value="<?=$_SESSION['userId']?>"readonly>
                                </div>
                                <div class="col-sm-4">
                                  <label>Assistant Name</label>
                                  <input type="text" name="assistant_name" class="form-control" value="<?=$_SESSION['rname']?>"readonly>
                                </div>
                            </div>
                            <br>
                            <div class="row">
