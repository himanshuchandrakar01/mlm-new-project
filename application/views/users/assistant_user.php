<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Assistant Management
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php
                    $userRecords1=$this->db->get("tbl_users")->result();
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                           <!--  <a class="btn btn-sm btn-primary" href="<?= base_url().'login-history/'.$record->userId; ?>" title="Login history"><i class="fa fa-history"></i></a> |  -->
                            ...
                            <a class="btn btn-sm btn-success deleteUser" href="<?= base_url().'admin-assistant-tree?id='.$record->userId.'&name='.$record->name.'&mobile='.$record->mobile; ?>" data-userid="<?php echo $record->userId; ?>" title="Delete"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                    <?php
               //}
