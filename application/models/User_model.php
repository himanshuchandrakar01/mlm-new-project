...
class User_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId,BaseTbl.roleId, BaseTbl.email, BaseTbl.name, BaseTbl.mobile, BaseTbl.isAdmin, BaseTbl.createdDtm, 
    ...
    function StateuserListing($searchText, $page, $segment)
    {
        $this->db->select('*');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Role', 'Role.roleId = BaseTbl.roleId','left');
    ...
    function add_bankDetails($userdetails)
    {
        $this->db->trans_start();
        $this->db->insert('bank_details', $userdetails);
    ...
    public function allusers($id,$searchText, $page, $segment)
    {
       $this->db->select('BaseTbl.userId,BaseTbl.roleId, BaseTbl.email, BaseTbl.name, BaseTbl.mobile, BaseTbl.isAdmin, BaseTbl.createdDtm, 
        Role.role, Role.status as roleStatus');
        $this->db->from('tbl_users as BaseTbl');
    ...
    public function userdataListing($id)
    {
