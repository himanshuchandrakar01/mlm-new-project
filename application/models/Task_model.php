...
class Task_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.taskId,BaseTbl.apply_for,BaseTbl.assistant_id,BaseTbl.assistant_name, BaseTbl.name, BaseTbl.gender, BaseTbl.dob,BaseTbl.father_husbandname,BaseTbl.profession,BaseTbl.blood_group,BaseTbl.state,BaseTbl.country,BaseTbl.mobileno,BaseTbl.aadharno,BaseTbl.address,BaseTbl.pincode,BaseTbl.email,BaseTbl.idcard,BaseTbl.profilepic,BaseTbl.frontcard,BaseTbl.backcard,BaseTbl.otherdoc,BaseTbl.created_at,tbl_users.payment_sts as payment_sts');
        $this->db->from('tbl_task as BaseTbl');
        $this->db->join('tbl_users','tbl_users.mobile=BaseTbl.mobileno');
        if(!empty($searchText)) {
