...
class Login_model extends CI_Model
{
    ...
    {
    $this->db->select('BaseTbl.userId,BaseTbl.password,BaseTbl.mobile,BaseTbl.payment_sts,BaseTbl.name,BaseTbl.roleId, BaseTbl.isAdmin,Roles.role, Roles.status as roleStatus, Roles.isDeleted as isRoleDeleted');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Roles','Roles.roleId = BaseTbl.roleId');
        $this->db->where('BaseTbl.mobile', $email);
        $this->db->where('BaseTbl.dob', $password);
