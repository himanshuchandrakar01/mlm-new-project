...
class Login extends CI_Controller
{
        ...
        else
        {
            ...
            if (!empty($result))
            {
                ...
                $sessionArray = array('userId'=>$result->userId,
                                        ...
                                        'payment_sts'=>$result->payment_sts,
                ...
                $_SESSION['rid']=$sessionArray['role'];
                $_SESSION['rname']=$sessionArray['name'];
                 $_SESSION['userId']=$sessionArray['userId'];
                 $_SESSION['payment_sts']=$sessionArray['payment_sts'];
                 
                 $_SESSION['mobile']=$sessionArray['mobile'];
                 // echo $_SESSION['rname'];
                 // exit();
                // if ($sessionArray['role']==14) {

                    
                // }

                redirect('/dashboard');
               //echo($sessionArray['role']);
    ...
    public function active_now()
    {
     ...
     $payment_data = array(
        ...
        return $this->load->view('payment/paymentmsg');
        }}
        $this->load->view('payment/addnewpayment');
