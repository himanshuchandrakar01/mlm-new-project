 ...
 */
class AddNewMember extends BaseController
{
    /**
    ...
    function addNewMem()
    {
        ...
        //     $data['roles'] = $this->user_model->getUserRoles();
            ...
            $this->global['pageTitle'] = 'NGO : Add New User';

            $this->loadViews("users/AddNewMembers", $this->global, NULL);
...
public function addtaskuser()
{
    $this->global['pageTitle'] = 'CodeInsect : Add New Task';
            ...
            $this->loadViews("task/addtaskuser", $this->global, NULL, NULL);
}
public function addtaskuser_db()
{
   // if ($_SERVER['REQUEST_METHOD']=='POST') {
     ...
     $membersignup_data = array(
        ...
        $userInfo = array('email'=>$email,'password'=>md5($dob),'dob'=>$dateformat,'address'=>$address, 'roleId'=>$roleId,
                ...
                $this->load->model('user_model');
                $result = $this->user_model->addNewUser($userInfo);
         return redirect('addtaskuser?success');
        }
    //}
}
