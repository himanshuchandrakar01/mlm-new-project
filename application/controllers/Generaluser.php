...
class Generaluser extends BaseController
{
    ...
    {
        parent::__construct();
        $this->load->model('Generaluser_model', 'tm');
        $this->isLoggedIn();
        $this->module = 'Generaluser';
    }
    ...
    {
        redirect('general/generalListing');
    }
    ...
    function generalListing()
    {
        ...
        {        
            ...
            $count = $this->tm->generalListingCount($searchText);

			$returns = $this->paginationCompress ( "generalListing/", $count, 10 );
            
            $data['generaluser'] = $this->tm->generalListing($searchText, $returns["page"], $returns["segment"]);

            //$sdata['generalusr']= $this->tm->generaluserdetails();
            
            $this->global['pageTitle'] = 'CodeInsect : Task';
            
            $this->loadViews("generaluser/list", $this->global, $data, NULL);
        }
    }
